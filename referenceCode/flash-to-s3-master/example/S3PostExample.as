package  
{
	...
	public class S3PostExample extends Sprite 
	{
		...
		public static const AMAZON_S3_BUCKET:String = "robtestbucket27";
		public static const AMAZON_S3_ACCESS_KEY:String = "AKIAJJIAP7OAFLB5KDJA";
		public static const AMAZON_S3_SECRET_ACCESS_KEY:String = "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";
		...
		private function onLoadComplete(e:Event):void
		{
			...
			options.acl = S3PostOptions.ACL_PUBLIC_READ_WRITE;
			options.contentType = S3PostOptions.CONTENT_TYPE_IMAGE_JPEG;
			options.secure = false;
			
			var policy:S3Policy = new S3Policy("10", "17", "2012", AMAZON_S3_BUCKET, key, accessKeys, options);
